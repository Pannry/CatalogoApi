...
namespace Catalogo6.Domain.Entities
{
    ...
    {
        public Produto(string nome, string descricao, float preco, string imagemUrl,
            float estoque, DateTime dataCadastro)
        {
        ...
        public void Update(string nome, string descricao, float preco, string imagemUrl,
            float estoque, DateTime dataCadastro, int categoriaId)
        {
            ValidateDomain(nome, descricao, preco, imagemUrl, estoque, dataCadastro);
            CategoriaId = categoriaId;
        }

        private void ValidateDomain(string nome, string descricao, float preco, string imagemUrl, float estoque, DateTime dataCadastro)
        {
